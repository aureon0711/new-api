...
func InitOptionMap() {
	...
	common.OptionMap["ChargeForEmptyOutputEnabled"] = strconv.FormatBool(common.ChargeForEmptyOutputEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" {
		...
		case "ChargeForEmptyOutputEnabled":
			common.ChargeForEmptyOutputEnabled = boolValue
